...
[Explorer](https://testnetexplorer.dero.io) [Source](https://github.com/onisoc/derohe) [Twitter](https://twitter.com/DeroProject) [Discord](https://discord.gg/H95TJDp) [Wiki](https://wiki.dero.io) [Github](https://github.com/onisoc/derohe) [DERO CryptoNote Mainnet Stats](http://network.dero.io) [Mainnet WebWallet](https://wallet.dero.io/) 
...
![DERO DAG stats.dero.io](https://raw.githubusercontent.com/onisoc/documentation/master/images/Dag1.jpeg)  
*DERO DAG Screenshot* [Live](https://stats.dero.io/)  

![DERO DAG network.dero.io](https://raw.githubusercontent.com/onisoc/documentation/master/images/dagx4.png)  
...
- Dero ultrafast bulletproofs optimization techniques in the form used did not exist anywhere in publicly available cryptography literature at the time of implementation. Please contact for any source/reference to include here if it exists.  Ultrafast optimizations verifies Dero bulletproofs 10 times faster than other/original bulletproof implementations. See: https://github.com/onisoc/derosuite/blob/master/crypto/ringct/bulletproof_ultrafast.go
...
[Mining](https://github.com/onisoc/wiki/wiki/Mining)  
...
2. In go workspace: ```go get -u github.com/onisoc/derohe/...```  
...
&nbsp; &nbsp; &nbsp; &nbsp; Download [DERO binaries](https://github.com/onisoc/derosuite/releases) for ARM, INTEL, MAC platform and Windows, Mac, FreeBSD, OpenBSD, Linux etc. operating systems.  
Most users required following binaries:  
[Windows 7-10, Server 64bit/amd64 ](https://github.com/onisoc/derosuite/releases/download/v2.1.6-1/dero_windows_amd64_2.1.6-1.alpha.atlantis.07032019.zip)  
[Windows 32bit/x86/386](https://github.com/onisoc/derosuite/releases/download/v2.1.6-1/dero_windows_x86_2.1.6-1.alpha.atlantis.07032019.zip)  
[Linux 64bit/amd64](https://github.com/onisoc/derosuite/releases/download/v2.1.6-1/dero_linux_amd64_2.1.6-1.alpha.atlantis.07032019.tar.gz)  
[Linux 32bit/x86](https://github.com/onisoc/derosuite/releases/download/v2.1.6-1/dero_linux_386_2.1.6-1.alpha.atlantis.07032019.tar.gz)  
[FreeBSD 64bit/amd64](https://github.com/onisoc/derosuite/releases/download/v2.1.6-1/dero_freebsd_amd64_2.1.6-1.alpha.atlantis.07032019.tar.gz)  
[OpenBSD 64bit/amd64](https://github.com/onisoc/derosuite/releases/download/v2.1.6-1/dero_openbsd_amd64_2.1.6-1.alpha.atlantis.07032019.tar.gz)  
[Mac OS](https://github.com/onisoc/derosuite/releases/download/v2.1.6-1/dero_apple_mac_darwin_amd64_2.1.6-1.alpha.atlantis.07032019.tar.gz)  
...
![DERO Daemon](https://raw.githubusercontent.com/onisoc/documentation/master/images/derod1.png)  
...
![DERO Wallet](https://raw.githubusercontent.com/onisoc/documentation/master/images/wallet-recover2.png)  
...
![DERO Explorer](https://github.com/onisoc/documentation/raw/master/images/dero_explorer.png)
...
![DERO Explorer Proving Transaction](https://github.com/onisoc/documentation/raw/master/images/explorer-prove-tx.png)
